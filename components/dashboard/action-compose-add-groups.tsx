...
import { PlusIcon , MagnifyingGlassIcon , ChevronDoubleLeftIcon , ChevronLeftIcon , ChevronRightIcon , ChevronDoubleRightIcon } from '@heroicons/react/20/solid'
...
export default function ActionComposeAddGroups ( props: Props ): JSX.Element {
            ...
            */
            e.target.id === 'window'
                &&  (
                        ...
                        setTimeout( () => setClasses( { ... classes , groups: { display: 'hidden' , opacity: 'opacity-0' , translate: 'translate-x-10' } } ) , 300 )
                    )
        } }
        id='window' //
        className={ `fixed z-50 left-0 top-0 right-0 bottom-0 justify-end bg-black/25 ${ classes.groups.display }` }
    >
        <div className={ `transition ease-in-out duration-300 ${ classes.groups.opacity } ${ classes.groups.translate }` }>
            ...
            <div className='flex flex-col space-y-3 bg-white w-[320px] h-screen p-5'>
                ...
                <div className='flex items-center justify-between w-full h-max'>
                    <h1 className='text-blue-600 text-lg font-open-sans-semibold capitalize'>add groups</h1>
                    <button
                        onClick={ ( e: any ) => {
                            setClasses( { ... classes , groups: { display: 'flex' , opacity: 'opacity-0' , translate: 'translate-x-10' } } )
                            setTimeout( () => setClasses( { ... classes , groups: { display: 'hidden' , opacity: 'opacity-0' , translate: 'translate-x-10' } } ) , 300 )
                        ...
                        <thead className='sticky top-0 w-full bg-gray-100 text-xs'>
                            ...
                            <tr className='border-gray-100 border-b'>
                                ...
                                <th scope='col' className='p-2 h-10 w-[45%]'>
                                    ...
                                    <div className='flex items-center justify-start h-full text-gray-800 font-open-sans-regular uppercase'>group name</div>
                            ...
                            :   loading || chunk.length === 0
                                    ?   <tbody className='relative -z-10 bg-white text-xs'>
                                            <tr className='border-gray-100 border-b'>
                                                ...
                                                <td scope='row' colSpan={ 3 } className='p-2'>
                                                    <div className='text-gray-900 font-open-sans-light text-xs'>no groups found.</div>
                                                </td>
                                            ...
                                            <tr key={ ind } className='border-gray-100 border-b'>
                                                <td scope='row' className='p-2 h-10 w-[45%]'>
                                                    ...
                                                    <div className='flex items-center justify-start h-full w-full'>
                                                        <span className='font-open-sans-light'>{ obj.gid }</span>
                                                    </div>
                                                ...
                                                <td scope='row' className='p-2 h-10 w-[45%]'>
                                                    ...
                                                    <div className='flex items-center justify-start h-full w-full'>
                                                        <span className='font-open-sans-light'>{ obj.name }</span>
                                                    </div>
                                                ...
                                                <td scope='row' className='p-2 h-10 w-[10%]'>
                                                    ...
                                                    <div className='flex items-center justify-start h-full w-full'>
                                                        <button
                                                            onClick={ ( e: any ) => {
                                                                setFields( { ... fields , contactno: obj.gid } )
                                                            } }
                                                            type='button'
