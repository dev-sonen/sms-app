...
export default function ActionSentDelete ( props: Props ): JSX.Element {

    const { query , all , menu , sent_del , disabled } = props
            ...
            all.current.childNodes.forEach( ( elem: any ) => {
                ...
                elem.id === 'list'
                    ...
                    &&  elem.firstChild.firstChild.firstChild.checked
                            ...
                            &&  sids.push( elem.firstChild.firstChild.firstChild.id )
            } )

            swal ( {
                title: 'delete this message?',
                text: `[${ sids.length }] item(s) selected.`,
                icon: 'warning',
                dangerMode: true,
            } )
            .then( async ( del ) => {
                ...
                if ( del ) {
                    ...
                    .then ( ( res: any ) => {
                        ...
                        .then ( ok => {
                            ...
                            router.push( `/dashboard/sent?token=${ query.token }` )
    ...
    >
        <button
            ...
            disabled={ menu || disabled || !sent_del }
        >
