...
export default function ActionQueuesDelete ( props: Props ): JSX.Element {

    const { query , all , menu , queue_del , disabled } = props
                ...
                if ( del ) {
                    ...
                    .then ( ( res: any ) => {
                        ...
                        .then ( ok => {
                            ...
                            router.push( `/dashboard/queues?token=${ query.token }` )
    ...
    >
        <button
            ...
            disabled={ menu || disabled || !queue_del }
        >
