...
export default function ActionGroupsDelete ( props: Props ): JSX.Element {

    const { query , all , menu , groups_del , disabled } = props
            ...
            all.current.childNodes.forEach( ( elem: any ) => {
                ...
                elem.id === 'list'
                    ...
                    &&  elem.firstChild.firstChild.firstChild.checked
                            ...
                            &&  gids.push( elem.firstChild.firstChild.firstChild.id )
            } )

            swal ( {
                title: 'delete this group?',
                text: `[${ gids.length }] item(s) selected.`,
                icon: 'warning',
                dangerMode: true,
            } )
            .then( async ( del ) => {
                ...
                if ( del ) {
                    ...
                    .then ( ( res: any ) => {
                        ...
                        .then ( ok => {
                            ...
                            router.push( `/dashboard/contacts/groups?token=${ query.token }` )
    ...
    >
        <button
            ...
            disabled={ menu || disabled || !groups_del }
        >
