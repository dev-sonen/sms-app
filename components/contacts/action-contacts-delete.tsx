...
interface Props {
    ...
    all: any
    menu: boolean
    contacts_del: boolean
    disabled: boolean
}

export default function ActionContactsDelete ( props: Props ): JSX.Element {

    const { query , all , menu , contacts_del , disabled } = props
                ...
                if ( del ) {
                    ...
                    .then ( ( res: any ) => {
                        ...
                        .then ( ok => {
                            ...
                            router.push( `/dashboard/contacts?token=${ query.token }` )
    ...
    >
        <button
            ...
            disabled={ menu || disabled || !contacts_del }
        >
